...
現在の `0.9.2` コアは、Vite + Phaser、Godot 4、LOVE2D、PixiJS + Vite、Three.js + Vite、Plain Canvas + Vite、Unity プロジェクトで sprite 画像ハンドオフ、visual reference 記録、motion 解析、animation compile/install、audio、atlas/tileset、UI アセットパイプラインと agent loop task packet をサポートしています。
