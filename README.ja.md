...
現在の `0.8.2` コアは、Vite + Phaser、Godot 4、LOVE2D、PixiJS + Vite、Three.js + Vite、Plain Canvas + Vite、Unity プロジェクトで sprite 画像ハンドオフと audio、atlas/tileset、UI アセットパイプラインをサポートしています。
