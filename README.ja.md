...
現在の `0.7.3` コアは、Vite + Phaser、Godot 4、LOVE2D、PixiJS + Vite、Plain Canvas + Vite で sprite 画像ハンドオフと P4 audio、atlas/tileset、UI アセットパイプラインをサポートしています。
...
- P4 audio、atlas/tileset、UI の compile/install/verify/report/rollback を同じローカル run-state パイプラインで処理。
