...
openRender Developer Kit 0.4.0 is local-first and agent-first. Keep changes aligned with the Developer Kit scope:
...
- Keep account, billing, licensing services, telemetry, and hosted APIs out of Developer Kit 0.4.0.
